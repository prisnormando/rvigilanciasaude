...
Observações:
    ...
    Comentários são importantes para explicar o código, torná-lo mais legível e facilitar a manutenção.
    Use comentários longos para fornecer contexto, explicar a lógica do código ou documentar funções.
    Evite usar strings de caracteres como comentários, pois isso não é uma prática eficiente.